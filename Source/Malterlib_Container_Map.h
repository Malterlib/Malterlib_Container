...
namespace NMib
{
	namespace NContainer
	{
		...
		{
			DMibIntrusiveLink(CMapTreeMemberBase, NIntrusive::TCAVLLink<>, m_Link);
		...
		template <typename t_CKey, typename t_CData = CMapNoData, typename t_CCompare = NMib::CSort_Default, typename t_CAllocator = NMib::NMem::CAllocator_Heap >
		class TCMap;
		...
		private:
			...
			struct CLinkTraits : public CMapTreeMemberBase::CLinkTraits_m_Link
			{
				typedef CMapTreeMember CNode;
			};

			typedef NIntrusive::TCAVLTree<CLinkTraits, CMapTreeMemberCompare, CAllocatorDisable> CAVLTree;
			typedef typename CAVLTree::COffset COffset; 
		...
		public:
			...
			class TCIterator
			{
				...
				typename NIntrusive::TCAVLTree<CLinkTraits, CMapTreeMemberCompare, CAllocatorDisable>::CIterator mp_Iter;
		...
		template <typename t_CKey, typename t_CData = CMapNoData, typename t_CCompare = NMib::CSort_Default, typename t_CAllocator = NMib::NMem::CAllocator_Virtual, mint t_GrowSize = 128, typename t_CPoolType = NMib::NMem::CPoolType_FreeableSmall, typename t_CLockType = NMib::NThread::CNoLock>
		class TCMapWithPool : public TCMap<t_CKey, t_CData, t_CCompare, NMem::TCPoolAllocator<TCMapTreeMember<t_CKey, t_CData>, t_GrowSize, t_CAllocator>>
		{
			typedef TCMap<t_CKey, t_CData, t_CCompare, NMem::TCPoolAllocator<TCMapTreeMember<t_CKey, t_CData>, t_GrowSize, t_CAllocator, t_CPoolType, t_CLockType>> CSuper;
		public:
			TCMapWithPool()
			{
			}
		...
		template <typename t_CKey, typename t_CCompare = NMib::CSort_Default, typename t_CAllocator = NMib::NMem::CAllocator_Heap>
		...
		{
			typedef TCSet<t_CKey, t_CCompare, NMem::TCPoolAllocator<TCMapTreeMember<t_CKey, CMapSet>>> CSuper;
		public:
			TCSetWithPool()
			{
			}
