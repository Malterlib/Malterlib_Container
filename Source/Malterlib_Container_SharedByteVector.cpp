...
namespace NMib::NContainer
{
		...
		, mp_pOwner(_Other.mp_pOwner)
	{
		...
		// Formed after the check, as the vector constructor does: an offset past the view is not
		// something the check can catch once the pointer has been made
	...
	{
		// The owner is taken hold of first: assigning it directly releases the current reference
		// before the source is read, which for a self assignment on the last holder frees the
		// bytes the members go on describing
