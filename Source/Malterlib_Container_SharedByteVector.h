...
namespace NMib::NContainer
{
	...
	struct CSharedByteVector
	{
		...
		// The owner releases its reference before reading the source, so assigning a view to
		// itself would drop the buffer and leave a dangling array behind a nonzero length
