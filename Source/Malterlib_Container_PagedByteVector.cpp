...
namespace NMib::NContainer
{
	...
	bool CPagedByteVector::f_ExpectAndRemoveFront(uint8 const *_pMatch, mint _nMatchBytes)
	{
	...
	bool CPagedByteVector::f_FindFront(uint8 const *_pMatch, mint _nMatchBytes, mint &_oPos) const
	{
		mint Pos = 0;
