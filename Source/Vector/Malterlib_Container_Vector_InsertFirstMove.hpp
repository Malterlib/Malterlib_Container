...
namespace NMib::NContainer
{
	...
	{
		//static_assert(NTraits::TCIsConstructorNothrowCallableWith<t_CData, void (typename NTraits::TCAddRValueReference<t_CData>::CType)>::mc_Value, "For exception safety type must be noexcept movable");
	...
	{
		//static_assert(NTraits::TCIsConstructorNothrowCallableWith<typename NTraits::TCRemoveReference<t_CData>::CType, void (typename NTraits::TCAddRValueReference<t_CData>::CType)>::mc_Value, "For exception safety type must be noexcept movable");
